...
('Mamão', 'fruta', 'tropical', 'natural', 'ambiente', 'in natura', 2.50, 43),
...
('Pêssego', 'fruta', 'global', 'natural', 'ambiente', 'in natura', 3.50, 39),
...
('Limão', 'fruta' 'global', 'natural', 'ambiente', 'in natura', 1.50, 29),
...
('Maracujá', 'fruta', 'tropical', 'natural', 'ambiente', 'in natura', 3.50, 97),
...
('Romã', 'fruta', 'global', 'natural', 'ambiente', 'in natura', 4.50, 83),
...
('Cajá', 'fruta', 'Brasil', 'natural', 'ambiente', 'in natura', 3.50, 46),
...
('Mangostão', 'fruta', 'Sudeste Asiático', 'natural', 'ambiente', 'in natura', 7.00, 73),
('Araçá', 'fruta', 'Brasil', 'natural', 'ambiente', 'in natura', 3.50, 50),
...
('Torta de Limão', 'doce', 'global', 'processado', 'frio', 'assado', 6.00, 320),
...
('Pavê de Bis', 'doce', 'Brasil', 'processado', 'frio', 'montado', 6.00, 340),
...
('Torta de Maçã', 'doce', 'global', 'processado', 'quente', 'assado', 6.50, 340),
('Cocada', 'doce', 'Brasil', 'processado', 'ambiente', 'cozido', 2.50, 120),
('Pavlova', 'doce', 'Austrália', 'processado', 'frio', 'assado', 7.00, 250),
('Creme Brulée', 'doce', 'França', 'processado', 'frio', 'assado', 8.00, 290),
...
('Pão de Mel', 'doce', 'global', 'processado', 'ambiente', 'assado', 4.00, 260),
('Pé de Moleque', 'doce', 'Brasil', 'processado', 'ambiente', 'cozido', 2.50, 180),
...
('Mousse de Maracujá', 'doce', 'Brasil', 'processado', 'frio', 'batido', 5.00, 200),
...
('Sorbet de Limão', 'doce', 'global', 'processado', 'frio', 'congelado', 4.00, 110),
('Bolo de Fubá', 'doce', 'Brasil', 'processado', 'ambiente', 'assado', 3.00, 220),
...
('Bolo Prestígio', 'doce', 'Brasil', 'processado', 'ambiente', 'assado', 4.50, 370);