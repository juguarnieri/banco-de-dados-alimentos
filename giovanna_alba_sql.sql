...
UPDATE alimentos SET origem = 'Brasil' WHERE nome = 'Jabuticaba';
UPDATE alimentos SET natural_processado = 'processado' WHERE origem = 'EUA';
...
UPDATE alimentos SET temperatura = 'frio' WHERE origem = 'Japão';
...
UPDATE alimentos SET metodo_preparo = 'assado' WHERE calorias = 100;
...
UPDATE alimentos SET origem = 'global' WHERE calorias = 227;
UPDATE alimentos SET preco = preco * 0.85 WHERE origem = 'global';
UPDATE alimentos SET calorias = calorias + 15 WHERE natural_processado = 'processado';
UPDATE alimentos SET tipo = 'salgado' WHERE nome = 'Pudim de Tapioca';
...
UPDATE alimentos SET preco = preco * 0.92 WHERE origem = 'Arabe';
...
UPDATE alimentos SET temperatura = 'ambiente' WHERE origem = 'Italia';
UPDATE alimentos SET preco = preco - 1.05 WHERE metodo_preparo = 'assado';
UPDATE alimentos SET tipo = 'fruta' WHERE preco = 10.00;
UPDATE alimentos SET calorias = calorias - 8 WHERE preco = 200.00;
...
UPDATE alimentos SET tipo = 'doce' WHERE nome = 'Castanha';
UPDATE alimentos SET metodo_preparo = 'assado' WHERE calorias = 100;
UPDATE alimentos SET preco = preco - 1.09 WHERE temperatura = 'ambiente';
UPDATE alimentos SET calorias = calorias - 12 WHERE metodo_preparo = 'frito';
UPDATE alimentos SET metodo_preparo = 'frito' WHERE origem = 'França';
...
UPDATE alimentos SET id = 555  WHERE nome = 'Pitaya';
UPDATE alimentos SET nome = 'Melancia' WHERE id = 28;
UPDATE alimentos SET metodo_preparo = 'cozido' WHERE id = 05;
...
UPDATE alimentos SET preco = preco * 1.10 WHERE origem = 'Franca';
UPDATE alimentos SET calorias = calorias * 1.10 WHERE origem = 'EUA';
UPDATE alimentos SET nome = 'Tomate cereja' WHERE id = 137;
UPDATE alimentos SET tipo = 'quente' WHERE nome = 'Araca'';                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                e' WHERE nome = 'Torta de Morango';
...
UPDATE alimentos SET nome = 'Bombocado' WHERE id = 15;
...
UPDATE alimentos SET metodo_preparo = 'assado' WHERE nome = 'Pao de alho';
UPDATE alimentos SET temperatura = 'ambiente' WHERE nome = 'Taco';
